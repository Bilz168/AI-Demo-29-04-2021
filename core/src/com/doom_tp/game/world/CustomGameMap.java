...
import com.doom_tp.game.world.customgamemap.CustomGameMapData;
import com.doom_tp.game.world.customgamemap.CustomGameMapLoader;
...
public class CustomGameMap extends GameMap {
	...
	public CustomGameMap() {
		...
		tiles = TextureRegion.split(new Texture("tiles_new.png"), TileType.TILE_SIZE, TileType.TILE_SIZE);
	}
