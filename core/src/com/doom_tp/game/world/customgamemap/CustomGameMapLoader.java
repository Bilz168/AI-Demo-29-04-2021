package com.doom_tp.game.world.customgamemap;
...
import com.doom_tp.game.world.TileType;
...
public class CustomGameMapLoader {
	...
	public static CustomGameMapData loadMap (String id, String name) {
		...
		if (file.exists()) {
			...
			CustomGameMapData data = generateRandomMapData(id, name);
	...
	public static CustomGameMapData generateRandomMapData (String id, String name) {
